...
public class Firmador extends GenericXMLSignature {
    ...
    public static void main(String... args) throws IOException {
        //if (args.length == 3) {    
        Firmador prueba = new Firmador("C:\\firma\\xml\\1007201401092754614300110010010000000031234567819.xml", "C:\\firma\\xmlF\\1007201401092754614300110010010000000031234567819.xml", "TH2010mas");
        prueba.firmar();
